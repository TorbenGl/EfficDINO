...
if __name__ == '__main__':
    ...
    if args.dump_features:
        ...
        results_path = args.dump_features
    ...
    if args.load_features:
        ...
        results_path = args.load_features
    else:
    ...
    if utils.get_rank() == 0:
        ...
        for k in args.nb_knn:
            ...
            print(f"{k}-NN classifier result with temp {args.temperature}: Top1: {top1}, Top5: {top5}")

            results[f"{k}-NN"] = {"Top1": top1, "Top5": top5}

        with open(os.path.join(results_path,f"knn_temp{args.temperature}_results.json"), "a") as f:
