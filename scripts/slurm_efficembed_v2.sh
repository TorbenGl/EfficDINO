#!/bin/bash
# =============================================================================
# SLURM job: EfficEmbedDINO ViT-B/16 — HuggingFace ImageNet-1k (v2)
#
...
# =============================================================================
#SBATCH --job-name=efficembed-vitb16-v2
...
cd "$REPO_DIR"
exec bash scripts/run_or_resume_v2.sh efficembed_vitb16
