#!/bin/bash
# =============================================================================
# SLURM job: SimDINOv2 ViT-B/16 baseline — DINOv2 pipeline, HF ImageNet
#
# Runs simdinov2/train/train.py (MCR loss, auto-resume from output-dir).
#
# BEFORE SUBMITTING:
...
# =============================================================================
#SBATCH --job-name=simdinov2-vitb16-baseline
...
#SBATCH --output=logs/simdinov2-baseline-%j.out
#SBATCH --error=logs/simdinov2-baseline-%j.err
...
cd "$REPO_DIR"
exec bash scripts/run_or_resume_dinov2.sh simdinov2_vitb16_baseline
