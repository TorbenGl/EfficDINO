#!/bin/bash
# =============================================================================
# k-NN evaluation — HuggingFace ImageNet-1k (v2)
#
# Usage:
#   HF_DATA_PATH=/datasets/imagenet-1k bash scripts/eval_knn_v2.sh <checkpoint_path>
#   HF_DATA_PATH=/datasets/imagenet-1k bash scripts/eval_knn_v2.sh <checkpoint_path> --embed_type efficembed --sub_patch_size 4
# =============================================================================
set -euo pipefail
